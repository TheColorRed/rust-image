...
This file explains *how an automated agent* should interact with this repository. It includes environment setup, common commands, constraints, tests.
...
- Always run `cargo test` and `cargo build`.
