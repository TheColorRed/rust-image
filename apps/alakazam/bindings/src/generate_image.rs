...
pub fn transparent_pattern(width: u32, height: u32, checker_size: u32) -> abra::prelude::Image {
  use abra::prelude::Image;
  let mut image = Image::new_from_color(width, height, Color::transparent());
