...
pub fn main() {
  ...
  let soft_brush = Brush::new().with_size(20).with_color(Color::red()).with_hardness(0.0);
  ...
  let hard_brush = Brush::new().with_size(15).with_color(Color::blue()).with_hardness(1.0);
